...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("img/atk_front.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("img/atk_up.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("img/def_front.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("img/def_up.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("img/idle.png");
		types.push (lime.Assets.AssetType.IMAGE);
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed (null, 640, 640, "000000");
		#end
		#else
		create ();
		#end
